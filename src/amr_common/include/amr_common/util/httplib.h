 ...
 */
#ifndef amr_COMMON_INCLUDE_amr_COMMON_HTTPLIB_H_
#define amr_COMMON_INCLUDE_amr_COMMON_HTTPLIB_H_
...
inline ssize_t write_content_chunked(
    Stream &strm, ContentProviderWithCloser content_provider) {
  size_t offset = 0;
...
inline std::shared_ptr<Response> Client::Post(
    const char *path, const MultipartFormDataItems &items) {
...
#endif  // amr_COMMON_INCLUDE_amr_COMMON_HTTPLIB_H_
