 ...
 */
#ifndef amr_COMMON_INCLUDE_amr_COMMON_THREAD_POOL_H_
#define amr_COMMON_INCLUDE_amr_COMMON_THREAD_POOL_H_
...
#endif  // amr_COMMON_INCLUDE_amr_COMMON_THREAD_POOL_H_
