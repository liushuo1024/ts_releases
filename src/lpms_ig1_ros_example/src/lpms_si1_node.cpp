...
public:
        ...
        private_nh("~")
    {
        ...
        autocalibration_serv = nh.advertiseService("enable_gyro_autocalibration", &LpSI1Proxy::setAutocalibration, this);
        autoReconnect_serv = nh.advertiseService("enable_auto_reconnect", &LpSI1Proxy::setAutoReconnect, this);
        gyrocalibration_serv = nh.advertiseService("calibrate_gyroscope", &LpSI1Proxy::calibrateGyroscope, this);
        resetHeading_serv = nh.advertiseService("reset_heading", &LpSI1Proxy::resetHeading, this);
        getImuData_serv = nh.advertiseService("get_imu_data", &LpSI1Proxy::getImuData, this);
        setStreamingMode_serv = nh.advertiseService("set_streaming_mode", &LpSI1Proxy::setStreamingMode, this);
        setCommandMode_serv = nh.advertiseService("set_command_mode", &LpSI1Proxy::setCommandMode, this);
...
int main(int argc, char *argv[])
{
    ...
    ros::init(argc, argv, "lpms_si1_node");
