...
public:
        ...
        private_nh("~")
    {
        ...
        autocalibration_serv = nh.advertiseService("enable_gyro_autocalibration", &LpCURS3Proxy::setAutocalibration, this);
        autoReconnect_serv = nh.advertiseService("enable_auto_reconnect", &LpCURS3Proxy::setAutoReconnect, this);
        gyrocalibration_serv = nh.advertiseService("calibrate_gyroscope", &LpCURS3Proxy::calibrateGyroscope, this);
        resetHeading_serv = nh.advertiseService("reset_heading", &LpCURS3Proxy::resetHeading, this);
        getImuData_serv = nh.advertiseService("get_imu_data", &LpCURS3Proxy::getImuData, this);
        setStreamingMode_serv = nh.advertiseService("set_streaming_mode", &LpCURS3Proxy::setStreamingMode, this);
        setCommandMode_serv = nh.advertiseService("set_command_mode", &LpCURS3Proxy::setCommandMode, this);
...
int main(int argc, char *argv[])
{
    ...
    ros::init(argc, argv, "lpms_curs3_node");
    ros::NodeHandle nh("imu");

    ros::AsyncSpinner spinner(0);
    spinner.start();

    LpCURS3Proxy lpCURS3(nh);
